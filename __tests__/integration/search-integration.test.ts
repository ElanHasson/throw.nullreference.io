...
const mockPosts: SearchResult[] = [
  {
    ...
    content: 'This comprehensive guide covers unit testing, integration testing, and end-to-end testing for React applications. Learn how to test components, hooks, and user interactions effectively.',
    featured: true,
  ...
  },
  {
    ...
    content: 'Learn how to profile and optimize Node.js applications for better performance. Covers memory management, CPU optimization, and database query optimization techniques.',
    featured: false,
  ...
  },
  {
    ...
    content: 'Discover TypeScript best practices for building maintainable, scalable applications. Learn about type safety, interfaces, generics, and advanced TypeScript features.',
    featured: true,
  ...
  },
  {
    ...
    content: 'Learn essential Docker security practices including image scanning, runtime security, network policies, and container hardening techniques for production deployments.',
    featured: false,
...
describe('Search Integration with Fuse.js', () => {
  ...
  describe('Edge cases', () => {
    ...
    it('should handle very long search queries', () => {
      const longQuery = 'This is a very long search query that contains multiple words and should still work properly'
  ...
  describe('Search configuration validation', () => {
    ...
    it('should respect threshold setting', () => {
      const results = fuse.search('completely unrelated search term that should not match anything at all')
