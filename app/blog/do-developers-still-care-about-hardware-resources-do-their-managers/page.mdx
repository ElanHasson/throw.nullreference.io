...
draft: false
featured: false
categories: ["Performance", "Random Thoughts"]
tags: ["Carelessness"]
series: ""
---
A few minutes ago I was presented with this dialog box:

![Close programs to prevent information loss - low on memory](/blog/do-developers-still-care-about-hardware-resources-do-their-managers/LowOnMemory.png#center "Scary dialog box that popped up.")
...
![Task Manager shows Maxed out RAM](/blog/do-developers-still-care-about-hardware-resources-do-their-managers/MemoryUsage.png#floatright "Task Manager shows Maxed out RAM")]
