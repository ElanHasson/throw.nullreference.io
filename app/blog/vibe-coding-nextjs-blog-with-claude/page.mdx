export const metadata = {
  ...
  description: "How we built a sophisticated Next.js MDX blog through iterative AI-assisted development - complete with search, RSS feeds, dark mode, and all the modern features you'd expect",
  featured: true,
