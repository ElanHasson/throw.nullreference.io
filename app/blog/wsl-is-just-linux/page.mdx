...
![A terminal window showing the output of lsb_release -a and uname -a which shows we're on Ubuntu 22.04 and running on WSL](/blog/wsl-is-just-linux/wsl-jammy.png)
