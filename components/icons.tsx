...
export function MastodonIcon({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function StackOverflowIcon({ className = 'h-6 w-6' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function SuccessIcon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
...
export function TipIcon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
...
export function NoteIcon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
