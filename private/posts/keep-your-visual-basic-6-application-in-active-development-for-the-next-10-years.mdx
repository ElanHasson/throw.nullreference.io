export const metadata = {
  ...
  featuredImage: "/posts/keep-your-visual-basic-6-application-in-active-development-for-the-next-10-years/Form_vide_VB.JPG",
...
<Figure src="/posts/keep-your-visual-basic-6-application-in-active-development-for-the-next-10-years/Form_vide_VB.JPG" alt="A Blast from the past: VB6 Form" className="float-right" />
