export const metadata = {
  ...
  featuredImage: "/posts/do-developers-still-care-about-hardware-resources-do-their-managers/LowOnMemory.png",
...
<Figure src="/posts/do-developers-still-care-about-hardware-resources-do-their-managers/LowOnMemory.png" alt="Close programs to prevent information loss - low on memory" caption="Scary dialog box that popped up." />
...
<Figure src="/posts/do-developers-still-care-about-hardware-resources-do-their-managers/MemoryUsage.png" alt="Task Manager shows Maxed out RAM" caption="Task Manager shows Maxed out RAM" className="float-right" />
