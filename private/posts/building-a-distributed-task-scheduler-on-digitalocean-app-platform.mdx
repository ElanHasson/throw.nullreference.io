export const metadata = {
  ...
  featuredImage: "/posts/building-a-distributed-task-scheduler-on-digitalocean-app-platform/scheduled-25134.png",
...
> **Info:** Check out [Part II: Designing the Web Scheduler](/blog/webscheduler-part-2-doing-the-design/) for implementation details.

> **Success:** Head over to DigitalOcean and [sign-up and give App Platform a try](https://m.do.co/c/0759a4937a7a) and get a $100 credit to use over 60 days.