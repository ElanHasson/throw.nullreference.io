export const metadata = {
  ...
  featuredImage: "/blog/do-developers-still-care-about-hardware-resources-do-their-managers/LowOnMemory.png",
  ...
  excerpt: "A reflection on how the hurry-up-and-ship mentality in software development has led to careless resource usage and performance issues.",
  tags: ["performance", "random-thoughts", "carelessness", "optimization", "management"],
  seo: {
    metaTitle: "Do Developers Still Care About Hardware Resources?",
    metaDescription: "Exploring how the rush to ship software has led developers to ignore performance optimization and hardware resource constraints.",
  },
};

A few minutes ago I was presented with this dialog box:

<Figure src="/blog/do-developers-still-care-about-hardware-resources-do-their-managers/LowOnMemory.png" alt="Close programs to prevent information loss - low on memory" caption="Scary dialog box that popped up." />
...
<Figure src="/blog/do-developers-still-care-about-hardware-resources-do-their-managers/MemoryUsage.png" alt="Task Manager shows Maxed out RAM" caption="Task Manager shows Maxed out RAM" className="float-right" />
