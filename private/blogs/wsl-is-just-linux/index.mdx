export const metadata = {
  ...
  featuredImage: "/blog/wsl-is-just-linux/wsl-jammy.png",
...
<Figure src="/blog/wsl-is-just-linux/wsl-jammy.png" alt="A terminal window showing the output of lsb_release -a and uname -a which shows we're on Ubuntu 22.04 and running on WSL" />
