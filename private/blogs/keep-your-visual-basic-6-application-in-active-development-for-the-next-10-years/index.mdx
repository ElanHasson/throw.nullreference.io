export const metadata = {
  ...
  featuredImage: "/blog/keep-your-visual-basic-6-application-in-active-development-for-the-next-10-years/Form_vide_VB.JPG",
  publishDate: "2014-05-02",
  lastModified: "2014-05-02",
  author: {
    name: "Elan Hasson",
    bio: "Software Developer and Tech Enthusiast",
    avatar: "/photos/elan_20250314_141124204.jpg",
  },
  excerpt: "How to balance business objectives with developer needs when migrating legacy Visual Basic 6 applications to modern technologies.",
  tags: ["visual-basic-6", "legacy-migration", "problems-solutions", "business-objectives"],
  seo: {
    metaTitle: "Keep Your Visual Basic 6 Application in Active Development for 10 Years",
    metaDescription: "Learn strategies for maintaining and extending Visual Basic 6 applications while gradually migrating to modern technologies like C#.",
  },
};
...
[Microsoft's official stance on Visual Basic 6.0](http://msdn.microsoft.com/en-us/vstudio/ms788708) is:

<Figure src="/blog/keep-your-visual-basic-6-application-in-active-development-for-the-next-10-years/Form_vide_VB.JPG" alt="A Blast from the past: VB6 Form" className="float-right" />
